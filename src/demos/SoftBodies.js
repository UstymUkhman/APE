...
export default class SoftBodies extends Playground {
  ...
  createObjects () {
    ...
    window.addEventListener('keydown', event => {
      switch (event.keyCode) {
        case 81:
          this.physics.hinge.enableMotor(hingeIndex, 1, 100);
          // ball.position.z += 1;
          break;
    ...
    window.addEventListener('keyup', () => {
      // this.physics.hinge.enableMotor(hingeIndex, 0, 100);
      this.physics.hinge.disableMotor(hingeIndex);
    }, false);
  ...
  createSoftObjects () {
    ...
    // setTimeout(() => {
    //   console.log('Soft disable');
    //   this.physics.soft.disable(softSphere);
    // }, 8000);

    // setTimeout(() => {
    //   console.log('Soft enable');
    //   this.physics.soft.enable(softSphere);
    // }, 18000);
  }
